...
const DeleteModal = ({ formula, onConfirm, onClose, deleting }) => (
  <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
    <div className="bg-white dark:bg-gray-900
      ...
      <h3 className="text-lg font-bold text-gray-800 dark:text-white">Delete Formula</h3>
      <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
        Are you sure you want to delete{" "}
        <span className="font-semibold text-gray-700 dark:text-gray-300">"{formula?.formulaName}"</span>?
